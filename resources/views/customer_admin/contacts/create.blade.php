...
<div class="max-w-2xl mx-auto">
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    <div class="mb-4">
      ...
      <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Add a new contact for your company.</p>
    </div>
    ...
    <form action="{{ route('customer-admin.contacts.store') }}" method="POST" class="space-y-4">
      @csrf
      ...
      {{-- optional company selector if your app supports contacts across companies --}}
      ...
      <div>
        ...
        <div class="text-xs text-gray-400 mt-1">Useful for internal notes (not shown to the contact).</div>
      </div>

      <div class="flex items-center gap-3">
        <button type="submit" class="px-4 py-2 rounded bg-blue-600 text-white hover:bg-blue-700">Create Contact</button>
