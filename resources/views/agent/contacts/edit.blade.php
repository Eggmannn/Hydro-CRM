...
<div class="max-w-2xl mx-auto">
  <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
    ...
    <form action="{{ route('agent.contacts.update', $contact->id) }}" method="POST" class="space-y-4">
      @csrf
      @method('PUT')
      ...
      {{-- Company is fixed for agent, no selector --}}
      ...
      <div class="flex items-center gap-3">
        ...
        <form action="{{ route('agent.contacts.destroy', $contact->id) }}"
              method="POST"
              onsubmit="return confirm('Delete contact? This action cannot be undone.')"
              class="ml-auto">
          @csrf
          @method('DELETE')
          <button type="submit"
